...
import UploadImage from "../../common/UplodeImage";
...
export default function UserProfile() {
  ...
  const handleEditForm = (index) => {
    ...
    setValue("full-name", address["full-name"]);
      ...
      {!imageUploadEnabled ? (
        <div>
          <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="border-t border-gray-200 px-4 py-6 sm:px-6 flex items-center">
            ...
            <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
              <button
                ...
                type="submit"
                className="rounded-md mr-3 my-5 bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Add New Address
              </button>
              <button
                ...
                type="submit"
                className="rounded-md my-5 bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Add Profile Photo
              </button>
        ...
        <UploadImage
          setImageUploadEnabled={setImageUploadEnabled}
