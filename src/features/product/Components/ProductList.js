...
import { selectAllUserInfo, selectLoggedInUser } from "../../auth/authSlice";
...
export default function ProductList() {
  ...
  useEffect(() => {
    ...
    dispatch(fetchProductsByFilltersAsync({ filter, sort, pagination,userType:'user' }));
  ...
  return (
    <>
    {allUserInfo.role==='admin'?<Navigate to='/admin' replace={true}></Navigate>:
                  ...
                  <div className="mt-4 flex justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-500">
                        ...
                        <span className="align-bottom">{product.rating!=0?Math.round(product.rating * 100) / 100:'No reviews yet'}</span>
                      </p>
                    </div>
                    <div>
