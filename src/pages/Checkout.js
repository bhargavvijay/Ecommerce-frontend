...
function Checkout() {
  ...
  const userInfoLoaded = useSelector(selectUserInfoLoded);
  ...
  let totalItems1 = totalItems();

  // const makePayment=async()=>{
  //   const stripe = await loadStripe('pk_test_51OrfRdBZotp1XksgXe34bzMQzxaiTANmJPwAcI1pp9S1d0Unbxc5ZVdj1goxlfRkm4r1sGeZJWr8zmH1voQ7NpZX00HeiKydCJ');
  //   const body = {
  //     products: items
  //   }
  //     const headers = {
  ...
  //     "pk_test_51OrfRdBZotp1XksgXe34bzMQzxaiTANmJPwAcI1pp9S1d0Unbxc5ZVdj1goxlfRkm4r1sGeZJWr8zmH1voQ7NpZX00HeiKydCJ"
  //   );
  //   const body = {
  //     products: items,
  ...
  const makePayment = async () => {
    ...
    const response = await fetch("https://ecommerce-backend-kyew.onrender.com/api/create-checkout-session", {
      method: "POST",
      headers: headers,
      body: JSON.stringify(body),
    });
                        ...
                        <li key={item.id} className="flex py-6">
                          ...
                          <div className="ml-4 flex flex-1 flex-col">
                            <div>
                              ...
                              <p className="ml-12 line-through inline-block text-gray-500">
